...
export default function EditNewsPage() {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        const response = await fetch(`/api/admin/content/news/${newsId}`);
        ...
        if (response.ok) {
          ...
          setFormData({
            ...
            published_date: news.published_date.slice(0, 16), // Format for datetime-local
          ...
          toast({
            title: "Error",
            description: data.error || "Failed to fetch news article",
            variant: "destructive",
          });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Error",
          description: data.error || "Failed to update news article",
          variant: "destructive",
        });
      }
    } catch (error) {
