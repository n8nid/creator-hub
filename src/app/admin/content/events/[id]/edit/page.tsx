...
interface Event {
  ...
  nomor_penyelenggara?: string | null;
  instagram_penyelenggara?: string | null;
}
      ...
      try {
        ...
        if (response.ok) {
          ...
          setFormData({
            ...
            status: event.status,
            pendaftaran_link: event.pendaftaran_link || "",
            nomor_penyelenggara: event.nomor_penyelenggara || "",
            instagram_penyelenggara: event.instagram_penyelenggara || "",
          });
        } else {
          toast({
            title: "Error",
