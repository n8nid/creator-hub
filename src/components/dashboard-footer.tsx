  ...
  return (
    <footer className="bg-white border-t border-gray-300 px-2 sm:px-6 py-6 sm:py-8 w-full overflow-hidden">
      <div className="max-w-7xl mx-auto w-full">
        {/* Konten utama */}
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 sm:gap-8 md:gap-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs sm:text-sm text-gray-600 max-w-md mt-2 break-words">
          ...
          {/* Kanan: Menu */}
          <div className="flex flex-row gap-8 sm:gap-16 md:gap-24">
            <div>
              <h4 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-xs sm:text-sm">
                Explore
              </h4>
        ...
        {/* Garis horizontal */}
        <div className="w-full border-t border-gray-300 my-4 sm:my-6"></div>

        {/* Bawah: copyright & ikon sosial */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
          <p className="text-xs text-gray-500 text-center md:text-left break-words px-2">
